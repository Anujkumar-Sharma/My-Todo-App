...
const TodoAnalytics = ({
  ...
  return (
    <div className="mt-[7px] pt-[18.61px] pb-[22.46px] bg-white-100-1 shadow-[0px_1.33px_6.65px_0px_#0000001A]">
      <div className="px-[20.61px] border-b-[1.33px] border-antiFlashWhite-100-1">
        <div className="flex justify-between pb-[22.68px]">
          <h4 className="font-inter-medium text-[13.3px] leading-[16.09px] text-black-100-1 font-medium flex flex-col gap-[1.28px]">
            <span>{getTitleForAnalytics(selectedTab!)}</span>
            <span className="text-[21.27px] leading-[25.75px] text-black-100-1 font-medium">
              {todos.length}
            </span>
          </h4>
          <InformationIcon />
