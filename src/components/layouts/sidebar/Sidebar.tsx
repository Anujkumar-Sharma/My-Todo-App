...
const Sidebar: FC<{ drawer: boolean; setDrawer: SetState<boolean> }> = ({
  ...
  return (
    <>
      ...
      <div
        className={classNames(
          "transition-all duration-300 h-[calc(100vh-56px)] md:h-auto justify-end fixed z-[255] dark:bg-raisinBlack-200-1 dark:md:bg-transparent md:z-0 left-0 top-14 overflow-auto md:overflow-hidden md:top-20 md:static px-6 md:p-0 shadow-[rgba(99,99,99,0.2)_0px_2px_8px_0px] dark:shadow-none md:shadow-none",
          drawer
            ? 'max-w-[300px] w-full sm:w-[340px] md:w-[280px] flex opacity-100'
